...
class HomeFragment : Fragment() {
    ...
    lateinit var dataListHome: ArrayList<ClassData>
    override fun onCreateView(
        ...
        if (dataListHome.isEmpty()) {
            BirinchiMartaIshlaganda()
        }

        rootHome.btn_card_internet.setOnClickListener {
            FragmentNavigater("Internet paketlar", "internet")
        }
        rootHome.btn_card_tarif.setOnClickListener {
            FragmentNavigater("Ta'riflar", "tarif")
        }
        rootHome.btn_card_daqiqa.setOnClickListener {
            FragmentNavigater("Daqiqalar", "daqiqa")
        }
        rootHome.btn_card_yangilik.setOnClickListener {
            FragmentNavigater("Yangiliklar", "yangilik")
        }
        rootHome.btn_card_sms.setOnClickListener {
            FragmentNavigater("SMS paketlar", "sms")
        }
        rootHome.btn_card_ussd.setOnClickListener {
            FragmentNavigater("USSD kodlar", "ussd")
        }
        rootHome.photo_ic_instagram.setOnClickListener {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/beeline_uzbekistan?utm_medium=copy_link"))
            startActivity(intent)
        }
        rootHome.photo_ic_telegram.setOnClickListener {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("tg://resolve?domain=beelineuzbekistan"))
            startActivity(intent)
        }
    ...
    private fun FragmentNavigater(stringTypeName: String, stringType: String) {
        Object.stringType = stringType
        Object.stringTypeName = stringTypeName
        findNavController().navigate(R.id.secondFragment)
    }

    private fun BirinchiMartaIshlaganda() {
        dataListHome.add(ClassData("internet",
        ...
        dataListHome.add(ClassData("tarif",
            "ZO'R 3",
            "20 000 so'm",
        ...
        dataListHome.add(ClassData("daqiqa",
            "200 Daqiqa",
            "10 000 so'm",
        ...
        dataListHome.add(ClassData("sms",
            "50 SMS",
            "1 000 so'm",
        ...
        dataListHome.add(ClassData("yangilik",
            "HURMATLI ABONENTLAR!",
            "25.01.2022",
        ...
        dataListHome.add(ClassData("ussd",
